...
export class EditProductComponent {
  editProduct: product = {id: "", productName: "", unitPrice:0,picture:""};
  ...
  constructor(private http: HttpClient,  
    ...
    this.editProduct = {id: data.id, productName: data.productName, unitPrice:data.unitPrice,picture:""};
  }
  ...
  handleDelete() {
    this.editProduct = {id: "", productName: "", unitPrice:0,picture:""};
    this.dialogRef.close();
  }
}
